...
<body>
			...
			<div class="container">
				...
				<div class="header-right">
						<div class="cart box_1">
							<a href="checkout.php">
								<h3><a style="color:white;" href="checkout.php" >Shopping cart</a>
								 </h3>
							</a>
							<p></p>
	...
	<div class="container">
		...
		<ul id="flexiselDemo3">
			<li><a href="register.html"><img src="images/l1.jpg" class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_sh
				elfItem">
					<a class="like_name" href="#">Jeans for Men</a>
					<p><a class="item_add" href="#"><i></i> <span class=" item_price">At Sale</span></a></p>
				</div>
			</li>
			<li><a href="register.html"><img src="images/l2.jpg" class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_sh
				elfItem">
			...
			<li><a href="register.html"><img src="images/l3.jpg" class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_sh
				elfItem">
			...
			<li><a href="register.html"><img src="images/l4.jpg" class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_sh
				elfItem">
			...
			<li><a href="register.html"><img src="images/l5.jpg" class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_sh
				elfItem">
				...
				<div class="span_of_4">
					...
					<div class="col-md-3 span1_of_4">
						...
						<ul class="f_nav">
							...
							<li><a href="index.php">create wishlist</a></li>
